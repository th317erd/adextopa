...
const RESULT_PROXY_CHILDREN = Symbol.for('/adextopa/results/proxy_children');
...
export class MatcherResult {
  ...
  static RESULT_PROXY_CHILDREN  = RESULT_PROXY_CHILDREN;
  static POSITIVE_RESULTS       = [ RESULT_SKIP, RESULT_TOKEN, RESULT_PROXY_CHILDREN ];
  ...
  static isPositiveResultType(resultType) {
    return (this.POSITIVE_RESULTS.indexOf(resultType) >= 0);
  }
