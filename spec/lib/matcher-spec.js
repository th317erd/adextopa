...
/*active*/fdescribe('Matcher', () => {
  describe('new', () => {
    it('works', () => {
      let matcher = new Matcher();
      expect(matcher.getName()).toBe('Matcher');
  ...
  describe('name', () => {
    it('works', () => {
      ...
      expect(matcher.getName()).toBe('Derp');
    });
  });
