...
export const IfAll = Matcher.createMatcherMethod((...matchers) => {
...
export const IfAny = Matcher.createMatcherMethod((...matchers) => {
  return new IfMatcher({
    matchers:   matchers.map(stringToFetch).filter(Boolean),
    matchAll:   false,
  });
...
export const IfNotAll = Matcher.createMatcherMethod((...matchers) => {
  return IfAll(...matchers).Invert(true).name('IfNotAll');
});

export const IfNot = IfNotAll;

export const IfNotAny = Matcher.createMatcherMethod((...matchers) => {
