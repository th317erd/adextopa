  ...
  constructor(_options) {
    ...
    Object.defineProperties(this, {
      ...
      'capturedRange': {
        ...
        enumerable:   true,
        configurable: true,
        value:        (options.capturedRange) ? this.safeClone(options.capturedRange) : new SourceRange({ start: context.parserRange.start, end: context.parserRange.start }),
      },
      'matchedValue': {
        enumerable:   false,
        configurable: true,
      ...
      'matchedRange': {
        ...
        enumerable:   true,
        configurable: true,
        value:        (options.matchedRange) ? new SourceRange(options.matchedRange) : new SourceRange({ start: context.parserRange.start, end: context.parserRange.start }),
      },
      'children': {
        writable:     true,
        enumerable:   true,
