...
export const FetchMatcher = Utils.makeKeysNonEnumerable(class FetchMatcher extends Matcher {
  ...
  createMatcherScope(context) {
    ...
    return {
      ...matcherScope,
      value: context.resolveValue(this),
    };
  }
  ...
  async exec(matcherScope) {
    ...
    return context.updateParserOffsetResult(startOffset, new PrimitiveMatcherResult(context, null, value));
  }
});

export const Fetch = Matcher.createMatcherMethod((keyName, defaultValue) => {
