...
export const ParserContext = Utils.makeKeysNonEnumerable(class ParserContext extends Scope {
  ...
  constructor(parser, parent, _options) {
    ...
    Object.defineProperties(this, {
      ...
      'parserRange': {
        ...
        enumerable:   false,
        configurable: true,
        value:        this.safeClone(options.parserRange) || new SourceRange(0, parser.getInputStream().sizeInChars()),
      },
      'startOffset': {
        enumerable:   false,
        configurable: true,
  ...
  resolveValue(value, opts) {
    if (value && typeof value[VIRTUAL_RESOLVER] === 'function')
      return this.resolveValue(value[VIRTUAL_RESOLVER](opts), opts);

    return value;
  }

  resolvePrimitive(value, opts) {
    let resolved = this.resolveValue(value, opts);
